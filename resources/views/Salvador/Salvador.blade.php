...
<body>
    ...
    <nav id="header" class="top-0 inset-x-0 z-50 sm-bk-blue fixed py-4">
        ...
        <div class="hidden xl:flex xl:items-center mx-8">
            ...
            <a href="{{ route('salvador') }}"> <img width="56" height="56"
                src="https://img.icons8.com/color/56/el-salvador-circular.png"
                alt="el-salvador-circular" /></a>
        </div>

        <!-- Sección derecha (oculta en dispositivos móviles) -->
        <div class="hidden xl:flex xl:flex-initial absolute top-7 -right-4">
            ...
            <div x-data="{ open: false, showModal: false }">
                ...
                <div x-show="open" class=" absolute sm-bk-blue opacity-95">
                    ...
                    <a class="py-2 px-16 block text-sm text-white hover:bg-gray-100 hover:text-black"
                        href="{{ route('tiendas') }}">Extensión Tienda</a>
                </div>
                 <!-- Modal -->
                        ...
                        <div class="mt-3 text-center sm:mt-5">
                            ...
                            <div class="mt-2">
                                <form method="POST" action="{{ route('sendEtica') }}" enctype="multipart/form-data" aria-label="Formulario de comentarios sobre ética">
                                    ...
                                    <div class="mt-12 border-b border-gray-200 focus-within:border-indigo-600">
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <span class="flex items-center">
                        ...
                        <span class="mx-2 font-medium"
                            onclick="window.open('https://sanmartinbakery.com.sv/login-manager/', '_blank')">Orden Manager</span>
                    </span>
                </button>
            </div>
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <span class="flex items-center">
                        ...
                        <span class="mx-2 font-medium"
                            onclick="window.open('http://192.168.111.212/usm/course/index.php?categoryid=245', '_blank')">Universidad San Martín</span>
                    </span>
                </button>
            </div>
            {{-- <div x-data="{ open: false }">
                ...
                <div class="block absolute left-6">
                    ...
                    <ul class="list-reset justify-end flex-1 mt-2 mx-auto ">
                        <div class="w-full flex-grow lg:flex lg:w-auto mt-2 lg:mt-0 lg:bg-transparent text-black lg:p-0 z-20"
                            ...
                            <a href="{{ route('salvador') }}" class="absolute top-1"> <img width="48" height="48"
                            ...
                            <div x-data="{ open: false }">
                                <button @click="open = !open"
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        <span class="mx-2 font-medium"
                                            onclick="window.open('https://sanmartinbakery.com.sv/login-manager/', '_blank')">Orden
                                            Manager</span>
                                    </span>
                                </button>
                            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-36">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img class="w-full shadow-xl rounded-3xl aos-init" src="temporada/3-3.png" alt="i4">
                        </div>
                        <div class="swiper-slide">
                            <img class="w-full shadow-xl rounded-3xl aos-init" src="temporada/cochinita-pibil-Facebook-Julio.png" alt="i5">
                        </div>
            ...
            <div class="relative">
                <div class="group aspect-h-20 aspect-w-10 block w-full overflow-hidden rounded-lg">
                    <img data-aos="fade-left" src="temporada/sv-Croissants-Facebook-Julio.gif" class="w-full shadow-xl rounded-3xl aos-init aos-animate">
                </div>
            </div>
            <div class="relative">
                <div class="group aspect-h-20 aspect-w-10 block w-full overflow-hidden rounded-lg">
                    <img data-aos="fade-left" src="temporada/galletass.jpg"
            ...
            <li class="relative divide-y divide-gray-200 rounded-lg sm-bk-blue opacity-90 text-center shadow">
                ...
                <div>
                    <div class="center">
                        <button
                            class="mx-auto lg:mx-0 hover:underline bg-white text-black font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                            <a onclick="window.open('http://192.168.111.212/usm/course/index.php?categoryid=245', '_blank')">Acceder</a>
                        </button>
                    </div>
                </div>
            </li>
