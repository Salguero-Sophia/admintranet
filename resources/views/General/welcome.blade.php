                    ...
                    <div class="relative transform overflow-hidden rounded-lg text-left shadow-xl lg:w-3/4 sm:w-5/6 transition-all mx-auto">
                        ...
                        <div class="swiper-container-3 px-8 pt-24">
                            <div class="swiper-wrapper">
                                ...
                                {{-- Apertura San Martín, Interplaza Chimaltenango --}}
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img src="actividades/ InterChimal1.jpeg" style="margin-left: 3%; margin-top:-10%" class="rounded-lg w-11/12" alt="actividades12">
                                        <div class="image-description -mt-24 ml-10">Apertura San Martín, Interplaza Chimaltenango</div>
                                    </div>
                                </div>

                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img src="actividades/ InterChimal2.jpeg" style="margin-left: 3%; margin-top:-10%" class="rounded-lg w-11/12" alt="actividades12">
                                        <div class="image-description -mt-24 ml-10">Apertura San Martín, Interplaza Chimaltenango</div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img src="actividades/ InterChimal3.jpeg" style="margin-left: 3%; margin-top:-10%" class="rounded-lg w-11/12" alt="actividades12">
                                        <div class="image-description -mt-24 ml-10">Apertura San Martín, Interplaza Chimaltenango</div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img src="actividades/ InterChimal4.jpeg" style="margin-left: 3%; margin-top:-10%" class="rounded-lg w-11/12" alt="actividades12">
                                        <div class="image-description -mt-24 ml-10">Apertura San Martín, Interplaza Chimaltenango</div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img src="actividades/ InterChimal5.jpeg" style="margin-left: 3%; margin-top:-10%" class="rounded-lg w-11/12" alt="actividades12">
                                        <div class="image-description -mt-24 ml-10">Apertura San Martín, Interplaza Chimaltenango</div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img src="actividades/ InterChimal6.jpeg" style="margin-left: 3%; margin-top:-10%" class="rounded-lg w-11/12" alt="actividades12">
                                        <div class="image-description -mt-24 ml-10">Apertura San Martín, Interplaza Chimaltenango</div>
                                    </div>
                                </div>
