    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Profesiones
                    ({{ $careersCount }})
                </h1>
                <p class="mt-2 text-sm text-gray-700">Listado de oportunidades vacantes</p>
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <a href="{{ route('careerCreate') }}" type="button"
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex gap-2 justify-center">
                                                <a href="{{ route('careerEdit', $career->id) }}"
                                                ...
                                                <a href="{{ route('careerDelete', $career->id) }}"
