    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold leading-6 text-gray-900 pb-5">{{ $category->name }}</h1>
            <h1 class="text-base font-semibold leading-6 text-gray-900">Sub Categorias</h1>
            <p class="mt-2 text-sm text-gray-700">Lista de sub categorias asignadas.</p>
          </div>
          <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            
            <form method="POST" action="{{ route('addSubCategory') }}" class="mt-4">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                     ...
                     <tr>
                         <td class="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                             ...
                             <div class="mt-1 text-gray-500">Descripción: <strong>{{ $subCategory->description }}</strong></div>
                         </td>
                         ...
                         <td class="relative whitespace-nowrap py-5 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                             <div class="flex gap-2 justify-center">
                                <a href="{{ route('categorySubCategoryDelete', [$category->id, $subCategory->id], ) }}" class="text-red-600 hover:text-red-900" title="Borrar">
