@php
    $menu = [
        ...
        (object) [
            ...
            'url'    => url('http://192.168.111.212/usm/course/index.php?categoryid=245',),
            'target' => '_blank',
        ],
    ];
@endphp
            ...
            <div class="flex h-20 items-center">
                ...
                <div class="ml-4 flex lg:ml-0 w-auto lg:hidden">
                    ...
                    <a href="{{ route('salvador') }}">
                        ...
                        <img class="h-13 w-auto" src="https://img.icons8.com/color/48/el-salvador-circular.png" alt="El Salvador Logo">
                    </a>
