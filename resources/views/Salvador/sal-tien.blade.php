...
<body>
        ...
        <nav id="header" class="sm-bk-blue p-1 z-50">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                <div class="hidden xl:flex xl:items-center mx-8">
                    ...
                    <a href="{{ route('salvador') }}"> <img width="56" height="56" src="https://img.icons8.com/color/56/el-salvador-circular.png" alt="el-salvador-circular" /></a>
                </div>
    ...
    <div class="container w-full md:w-10/12 xl:w-11/12 mx-auto px-4 mt-8 mb-8 xl:py-36">
