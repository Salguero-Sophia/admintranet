    ...
    <form method="POST" action="{{ route('categoryAdd') }}">
        ...
        <div class="space-y-12">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm leading-6 text-gray-600">Crear nueva categoria.</p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="nameCategory" id="nameCategory" autocomplete="given-name"
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-2">
                            <input type="number" name="orderCategory" id="orderCategory" autocomplete="given-name"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="{{ route('categoriesList') }}" type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
            <button type="submit"
